...
local function GetAssetImage(iconName)
    ...
    if assetId then
        if AssetImageCache[assetId] then
            return AssetImageCache[assetId]
        end
        ...
        if not resolvedImage or resolvedImage == "" then
            pcall(function()
                local info = MarketplaceService:GetProductInfo(tonumber(assetId))
                if info and info.IconImageAssetId and info.IconImageAssetId ~= 0 then
                    resolvedImage = "rbxassetid://" .. tostring(info.IconImageAssetId)
                end
            end)
        end

        if not resolvedImage or resolvedImage == "" then
            resolvedImage = "rbxassetid://" .. assetId
        end

        AssetImageCache[assetId] = resolvedImage
...
local function CreateIcon(iconName, size, colorOrTheme)
    ...
    if Icons then
        ...
        elseif typeof(colorOrTheme) == "Color3" then
            ...
            colors = { Color3.fromRGB(235, 246, 255) }
        end
    ...
    img.BackgroundTransparency = 1
    img.Size = size or UDim2.fromOffset(18, 18)
    img.ImageColor3 = (typeof(colorOrTheme) == "Color3" and colorOrTheme) or Color3.fromRGB(235, 246, 255)
...
local Library = { 
    ...
    local Themes = {
        ["Preset"] = {
            ["Background"] = Color3.fromRGB(10, 16, 28),
            ["Inline"] = Color3.fromRGB(14, 25, 42),
            ["Accent Start"] = Color3.fromRGB(75, 184, 250),
            ["Accent End"] = Color3.fromRGB(21, 145, 220),
            ["Text"] = Color3.fromRGB(235, 246, 255),
            ["Text 2"] = Color3.fromRGB(142, 166, 190),
            ["Element"] = Color3.fromRGB(20, 43, 68),
            ["Hovered Element"] = Color3.fromRGB(30, 71, 111),
            ["Topbar"] = Color3.fromRGB(14, 31, 54)
        }
    }
        ...
        Library.CreateColorpicker = function(Self, Data)
            ...
            local Items = { } do 
                Items["ColorpickerButton"] = Library:Create("TextButton", {
                    ...
                    BorderSizePixel = 0,
                    TextSize = 14,
                    BackgroundColor3 = Color3.fromRGB(235, 246, 255)
                })
        ...
        Library.CreateKeybind = function(Self, Data)
            ...
            local Items = { } do
                Items["KeyButton"] = Library:Create("TextButton", {
                    ...
                    Name = "\0",
                    FontFace = Library.Font,
                    TextColor3 = Color3.fromRGB(235, 246, 255),
                    BorderColor3 = Color3.fromRGB(0, 0, 0),
                    Text = "BackSpace",
                    AutoButtonColor = false,
                    ...
                    TextSize = 14,
                    BackgroundColor3 = Color3.fromRGB(20, 43, 68)
        ...
        Library.Window = function(Self, Params)
            ...
            local Items = { } do 
                ...
                Items["Top"] = Library:Create("Frame", {
                    ...
                    BorderSizePixel = 0,
                    BackgroundColor3 = Color3.fromRGB(14, 31, 54)
                ...
                Items["CloseButton"] = Library:Create("ImageButton", {
                    Parent = Items["Top"].Instance,
                    Name = "\0",
                    ImageColor3 = Color3.fromRGB(235, 246, 255),
                    BorderColor3 = Color3.fromRGB(0, 0, 0),
                    AutoButtonColor = false,
                ...
                Items["Pages"] = Library:Create("ScrollingFrame", {
                    ...
                    ScrollBarImageColor3 = Color3.fromRGB(54, 92, 130),
                ...
                Items["Content"] = Library:Create("Frame", {
                    ...
                    BorderSizePixel = 0,
                    BackgroundColor3 = Color3.fromRGB(14, 25, 42)
            ...
            local toggleIconSize = UDim2.fromOffset(52, 52)
            ...
            Library:Create("UIStroke", {
                ...
                Color = Color3.fromRGB(54, 92, 130),
                Thickness = 1.5
            })

            -- Add the logo icon to the toggle button
            local toggleIcon = CreateIcon(Window.Logo, toggleIconSize)
            ...
            function Window:Notify(Data)
                ...
                NotifFrame.BackgroundColor3 = Library.Theme and Library.Theme.Background or Color3.fromRGB(10, 16, 28)
                ...
                NotifStroke.Color = Library.Theme and Library.Theme.Outline or Color3.fromRGB(54, 92, 130)
                ...
                TitleLabel.TextColor3 = Library.Theme and Library.Theme.Text or Color3.fromRGB(235, 246, 255)
                ...
                DescLabel.TextColor3 = Library.Theme and Library.Theme["Text Dark"] or Color3.fromRGB(142, 166, 190)
                ...
                ProgressBg.BackgroundColor3 = Library.Theme and Library.Theme.Inline or Color3.fromRGB(14, 25, 42)
        ...
        Library.Page = function(Self, Params)
            ...
            local Items = { } do 
                ...
                if Page.Search then 
                    ...
                    Items["Input"] = Library:Create("TextBox", {
                        ...
                        BorderSizePixel = 0,
                        BackgroundTransparency = 1,
                        PlaceholderColor3 = Color3.fromRGB(142, 166, 190),
                        AutomaticSize = Enum.AutomaticSize.X,
            ...
            function Page:Turn(Bool)
                ...
                if Bool then 
                    ...
                    Items["UIStroke"].Instance.Color = Color3.fromRGB(54, 92, 130)
        ...
        Library.SubPage = function(Self, Params)
            ...
            function Page:Turn(Bool)
                ...
                if Bool then 
                    ...
                    if IsAssetId(Page.Icon) then
                        Items["Icon"]:Tween({ImageTransparency = 0.15})
                    else
